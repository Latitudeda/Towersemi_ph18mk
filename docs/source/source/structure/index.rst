...
* ``components``
    ...
    * Parametrized cells (PCells): Designed by **LDA**, including ``Bend``, ``Straight``, ``Bond Pad`` and ``Taper``. Please see ``gpdk > components`` for more designed components by **LDA**.
